...
export const privateRoutes = [
  ...
  { path: '/meal-library', element: <PrivateRoute><MealLibraryPage /></PrivateRoute> },
  { path: '/plan-meal', element: <PrivateRoute><PlanMealPage /></PrivateRoute> },
  { path: '/nutrition-stats', element: <PrivateRoute><MacroAnalysisPage /></PrivateRoute> },
];

export const publicRoutes = [
  { path: '/signup', element: <PublicRoute><SignUpPage /></PublicRoute> },
  { path: '/signin', element: <PublicRoute><LoginPage /></PublicRoute> },
];
