...
const SignupForm = ({
  ...
  return (
    ...
    >
      <Card className="p-8 rounded-xl shadow-lg w-full max-w-md text-center  text-white">
        <img
          src="/MealMate.png"
          alt="MealMate Logo"
          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <TextField
                ...
                fullWidth
                variant="outlined"
                className="bg-white rounded-md border border-[#16423C] focus:border-[#16423C] focus:ring-[#16423C]"
              />
            </Grid>
